    ...
    <body id="body">
        ...
        <div id="loading-mask">
            <div class="loading-img">
                <img alt="Meghna Preloader" src="img/bts5.gif"  />
                <img id="logobts" alt="logo" src="img/logo3.png"  />
            </div>
        </div>
        <!--
        End Preloader
                ...
                <div class="sl-slider">
                    ...
                    <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
                        <div class="sl-slide-inner">
                            <img id=imagem3 src=img/slides/bts2.jpg alt=bts9>
                            <div class="carousel-caption">
                                <div>
                                    <img id="logobangtan" class="wow fadeInUp" src="img/bts4.gif" alt="Meghna">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="sl-slide" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
                        <div class="sl-slide-inner">
                            <img id=imagem2 src="img/slides/bts12.jpg" alt=bts3>
                        </div>
                    </div>
                    <!-- /single slide item -->
                    ...
                    <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1">
                        <div class="sl-slide-inner">
                            <img id=imagem1 src=img/slides/bts4.jpg alt=bts4>
                        </div>
                    </div>
                    <!-- /single slide item -->
                    ...
                    <br> <div id="features">
                        <div class="item">
                            ...
                            <div class="features-item">
                                ...
                                <!-- features media -->
                                <img id="sobre" src="img/bangtan1.png" alt="sobre">
                                <!-- /features media -->
                        ...
                        <div class="item">
                            <div class="features-item">
                                ...
                                <div class="col-md-6 feature-media wow fadeInUp" data-wow-duration="500ms">
                                    <img src="img/slides/bts7.jpg" alt="3D Beach Art | Meghna" class="img-responsive">
                                </div>
                                <!-- /features media -->
        ...
        <section id="showcase">
            ...
            <div class="portfolio-item-wrapper wow fadeInUp" data-wow-duration="500ms">
                <ul id="og-grid" class="og-grid">
                    ...
                    <!-- single portfolio item -->
                    <li class="mix web">
                        <a href="javascript:void(0)" data-largesrc="img/portfolio/suga2.jpg" data-title="Min Yoongi" data-description="Nome Artístico: Suga<br>Data de Nascimento: 09/03/1993 <br>Cidade Natal: Daegu <br>Posição: Rapper<br>Altura: 1,76<br>Cor Favorita: Branco<br>Comida Favorita: Carne, carne, carne">
                            <img id="integrantes" src="img/portfolio/suga7.jpg" alt="Meghna">
                            <div class="hover-mask">
                                <h3>Suga</h3>
                                <span>
                                    <i class="fa fa-plus fa-2x"></i>
                    ...
                    <li class="mix photoshop">
                        <a href="javascript:void(0)" data-largesrc="img/portfolio/rm3.jpg" data-title="Kim Namjoon" data-description="Nome Artístico: Rap Monster <br>Data de Nascimento: 12/09/1994 <br>Cidade Natal: Ilsan <br>Posição: Líder, rapper e compositor<br>Altura: 1,81<br>Cor Favorita: Preto<br>Comida Favorita: Carne, Korean knife noodles (Macarrão coreano)">
                            <img id="integrantes" src="img/portfolio/rm2.jpg" alt="Meghna">
                            <div class="hover-mask">
                                <h3>Rap Monster</h3>
                                <span>
                                    <i class="fa fa-plus fa-2x"></i>
                    ...
                    <li class="mix illustrator">
                        <a href="javascript:void(0)" data-largesrc="img/portfolio/jh3.jpg" data-title="Jung Hoseok" data-description="Nome Artístico: J-Hope <br>Data de Nascimento: 18/02/1994 <br>Cidade Natal: Gwangju <br>Posição: Rapper e dançarino<br>Altura: 1,77<br>Cor Favorita: Verde<br>Comida Favorita: Kimchi">
                            <img id="integrantes" src="img/portfolio/jh2.jpg" alt="Meghna">
                            <div class="hover-mask">
                                <h3>J-Hope</h3>
                                <span>
                                    <i class="fa fa-plus fa-2x"></i>
                    ...
                    <!-- single portfolio item -->
                    <li class="mix app">
                        <a href="javascript:void(0)" data-largesrc="img/portfolio/v2.jpg" data-title="Kim Taehyung" data-description="Nome Artístico: V<br>Data de Nascimento: 30/12/1995<br>Cidade Natal: Daegu <br>Posição: Vocalista<br>Altura: 1,78<br>Cor Favorita: Verde, preto e branco<br>Comida Favorita: Japchae, qualquer tipo de carne">
                            <img id="integrantes" src="img/portfolio/v3.jpg" alt="Meghna">
                            <div class="hover-mask">
                                <h3>V</h3>
                                <span>
                                    <i class="fa fa-plus fa-2x"></i>
                    ...
                    <!-- single portfolio item -->
                    <li class="mix web">
                        <a href="javascript:void(0)" data-largesrc="img/portfolio/jk2.jpg" data-title="Jeon Jeongguk" data-description="Nome Artístico: Jungkook <br>Data de Nascimento: 01/09/1997 <br>Cidade Natal: Busan <br>Posição: Maknae, Vocalista, Rapper e Dançarino<br>Altura: 1,77<br>Cor Favorita: Preto, vermelho e branco<br>Comida Favorita: Pão, pizza, qualquer coisa com farinha.">
                            <img id="integrantes" src="img/portfolio/jk1.jpg" alt="Meghna">
                            <div class="hover-mask">
                                <h3>Jungkook</h3>
                                <span>
                                    <i class="fa fa-plus fa-2x"></i>
                ...
                <div class="row">
                    ...
                    <div class="clearfix">
                        ...
                        <article id="disco" class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="600ms">
                            <div class="note kill-margin-bottom">
                                <div class="media-wrapper">
                                    <img src="img/blog/24.jpg" alt="amazing caves coverimage" class="img-responsive">
                                </div>
                                <div class="excerpt">
                        ...
                        <article id="disco" class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="600ms">
                            <div class="note kill-margin-bottom">
                                <div class="media-wrapper">
                                    <img src="img/blog/82.jpg" alt="amazing caves coverimage" class="img-responsive">
                                </div>
                                <div class="excerpt">
                                    <h3>O!RUL8,2?</h3>
                        ...
                        <article id="disco" class="col-md-3 col-sm-6 col-xs-12 clearfix wow fadeInUp" data-wow-duration="500ms">
                            <div class="note">
                                <div class="media-wrapper">
                                    <img src="img/blog/sla.jpg" alt="amazing caves coverimage" class="img-responsive">
                                </div>
                        ...
                        <article id="disco" class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="400ms">
                            <div class="note">
                                <div class="media-wrapper">
                                    <img src="img/blog/slase.jpeg" alt="amazing caves coverimage" class="img-responsive">
                                </div>
                        ...
                        <article id="disco" class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="600ms">
                            <div class="note kill-margin-bottom">
                                <div class="media-wrapper">
                                    <img src="img/blog/dw.jpg" alt="amazing caves coverimage" class="img-responsive">
                                </div>
                                <div class="excerpt">
                                    <h3>DARK&WILD</h3>
                        ...
                        <article id="disco" class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="600ms">
                            <div class="note kill-margin-bottom">
                                <div class="media-wrapper">
                                    <img src="img/blog/mbml.jpg" alt="amazing caves coverimage" class="img-responsive">
                                </div>
                                <div class="excerpt">
                        ...
                        <article id="disco" class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="600ms">
                            <div class="note kill-margin-bottom">
                                <div class="media-wrapper">
                                    <img src="img/blog/mbmlw.jpg" alt="amazing caves coverimage" class="img-responsive">
                                </div>
                                <div class="excerpt">
                        ...
                        <article id="disco" class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="600ms">
                            <div class="note kill-margin-bottom">
                                <div class="media-wrapper">
                                    <img src="img/blog/mbmlb.jpg" alt="amazing caves coverimage" class="img-responsive">
                                </div>
                                <div class="excerpt">
                        ...
                        <article id="disco" class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="600ms">
                            <div class="note kill-margin-bottom">
                                <div class="media-wrapper">
                                    <img src="img/blog/mbmlp.jpg" alt="amazing caves coverimage" class="img-responsive">
                                </div>
                                <div class="excerpt">
                        ...
                        <article id="disco" class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="600ms">
                            <div class="note kill-margin-bottom">
                                <div class="media-wrapper">
                                    <img src="img/blog/mbmld.jpg" alt="amazing caves coverimage" class="img-responsive">
                                </div>
                                <div class="excerpt">
                        ...
                        <article id="disco" class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="600ms">
                            <div class="note kill-margin-bottom">
                                <div class="media-wrapper">
                                    <img src="img/blog/mbmln.jpg" alt="amazing caves coverimage" class="img-responsive">
                                </div>
                                <div class="excerpt">
                        ...
                        <article id="disco" class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="600ms">
                            <div class="note kill-margin-bottom">
                                <div class="media-wrapper">
                                    <img src="img/blog/w.jpg" alt="amazing caves coverimage" class="img-responsive">
                                </div>
                                <div class="excerpt">
                                    <h3>Wings</h3>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="copyright text-center">
                            <a href="telalogin.jsp">
                                <img id="logobts" src="img/bts1.png" alt="Meghna" /> 
                            </a>
                            <br/>
                        </div>
                        <!-- /copyright --> 
